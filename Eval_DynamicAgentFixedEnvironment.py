# -*- coding: utf-8 -*-
"""
Created on Thu Dec 13 14:17:45 2018
@author: Hesham El Abd
"""
from DynamicAgentFixedEnvironment import DynamicAgent,FixedEnv
...
print('initial reward estimation=1 and step size of 0.1')
agent_SumRewards_StepSize_p_one=[] 
for j in range(10):
    dynamicAgent =DynamicAgent(10,1,0.1)
    Environment=FixedEnv(binnary_reward=True,
...
## step size= 0.5 
print('initial reward estimation=1 and step size of 0.5')
